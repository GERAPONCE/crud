...
function leer(){
    ...
    for(let i= 0; i < libros.length; i++){
        ...
        `<tr>
            ...
            <td>${descripcion}</td>
            <td>${precio}</td>
            <td><button onclick="eliminar('${titulo}')" class="btn btn-danger">Eliminar</button>
            <td><button onclick="editar('${titulo}')" class="btn btn-success">Editar</button>
        </tr>    
        `
    }
}
